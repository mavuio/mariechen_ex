defmodule MariechenWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MariechenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MariechenWeb.Gettext, "errors", msg, opts)
    end
  end
end
